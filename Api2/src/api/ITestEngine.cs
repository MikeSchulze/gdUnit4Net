...
public interface ITestEngine : IDisposable
{
    ...
    /// </summary>
    /// <returns>Version information of the engine, or null if the gdUnit4Api2 is not installed</returns>
    /// <exception cref="InvalidOperationException">Thrown when gdUnit4Api2 is not properly installed</exception>
    /// <remarks>
    ...
    {
        var assembly = typeof(GdUnit4TestEngine).Assembly ?? throw new InvalidOperationException("No 'gdUnit4Api2' is installed!");
