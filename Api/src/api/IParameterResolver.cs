...
public interface IParameterResolver : ITestExtension
{
    ...
    /// <param name="executionContext">The extension context providing information about the test suite and execution.</param>
    /// <returns>True if the parameter is supported.</returns>
    bool SupportsParameter(IParameterContext parameterContext, IExtensionContext executionContext);
    ...
    object? ResolveParameter(IParameterContext parameterContext, IExtensionContext executionContext);
}
