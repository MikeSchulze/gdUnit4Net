...
internal static class LoggerFactory
{
    ...
    internal static ITestEngineLogger Root => root;
    ...
    internal static ITestEngineLogger Current => Contextual.Value ?? root;
    ...
    /// <summary>
    ///     Begins a task-local log scope for the current async execution context.
    ...
    /// </summary>
    internal static void BeginScope(string scopeId)
    ...
    /// <summary>Ends the task-local log scope, restoring <see cref="Current" /> to <see cref="Root" />.</summary>
    internal static void EndScope() => Contextual.Value = null;
